    ...
    <div class="mine h-100rem">
      ...
      >
        ...
        <img
          ...
          alt=""
          class="rounded-full w-20 h-20 mx-auto border-2 shadow-border-white md shadow-gray-400 absolute bottom-0 left-5 transform translate-y-[3rem]"
        />
      </div>
      <!-- 页面主体 -->
...
const { mineTopBarItems } = toRefs(mineStore);
</script>
